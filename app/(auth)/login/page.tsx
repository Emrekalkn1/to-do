    ...
    return (
        <div className="card">
            <div style={{ textAlign: 'center', marginBottom: '30px' }}>
                ...
                <h1 style={{ marginBottom: '8px', color: 'var(--text-main)', fontSize: '28px' }}>Hoş Geldiniz</h1>
                <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>Devam etmek için giriş yapın</p>
            </div>
            ...
            <div style={{ marginTop: '24px', textAlign: 'center', fontSize: '14px', color: 'var(--text-secondary)' }}>
                Hesabınız yok mu? <Link href="/register" style={{ color: 'var(--primary)', fontWeight: 600 }}>Kayıt Olun</Link>
            </div>
        </div>
    )
}
